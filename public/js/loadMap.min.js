function initMap(e){function k(){for(;0!=f.length;)f.pop().setMap(null);var b=new XMLHttpRequest;b.open("GET","https://api-v3.mbta.com/vehicles?filter[route]=Green-B,Green-C",!0);b.onreadystatechange=function(){if(4==b.readyState&&"200"==b.status)for(var d=JSON.parse(this.responseText),c=0;c<d.data.length;c++){var a=d.data[c],h={lat:a.attributes.latitude,lng:a.attributes.longitude},g={path:google.maps.SymbolPath.FORWARD_CLOSED_ARROW,strokeColor:"green",rotation:a.attributes.bearing,anchor:new google.maps.Point(0,
2),scale:4};a=new google.maps.Marker({position:h,title:a.id,map:e,icon:g});f.push(a)}};b.send();setTimeout(k,1E4)}function l(){for(;0!=g.length;)g.pop().setMap(null);var b=new XMLHttpRequest;b.open("GET","api/buShuttle",!0);b.onreadystatechange=function(){if(4==b.readyState&&"200"==b.status)for(var d=JSON.parse(this.responseText),c=0;c<d.ResultSet.Result.length;c++){var a=d.ResultSet.Result[c],h={lat:parseFloat(a.lat),lng:parseFloat(a.lng)},f={path:google.maps.SymbolPath.FORWARD_CLOSED_ARROW,strokeColor:"red",
fillColor:"red",fillOpacity:1,anchor:new google.maps.Point(0,2),rotation:parseInt(a.heading),scale:4};a=new google.maps.Marker({position:h,title:a.call_name,map:e,icon:f});g.push(a)}};b.send();setTimeout(l,1E4)}var f=[],g=[];e=new google.maps.Map(document.getElementById("map"),{center:{lat:42.3483459,lng:-71.1029828},zoom:15,disableDefaultUI:!0});e.setOptions({styles:[{featureType:"landscape",stylers:[{visibility:"off"}]},{featureType:"poi",stylers:[{visibility:"off"}]},{featureType:"road",stylers:[{visibility:"on"}]},
...
{featureType:"water",elementType:"labels.text",stylers:[{color:"#8a8a8a"}]}]});(function(){var b=new XMLHttpRequest;b.open("GET","https://api-v3.mbta.com/shapes?filter[route]=Green-B,Green-C",!0);b.onreadystatechange=function(){if(4==b.readyState&&"200"==b.status)for(var d=JSON.parse(this.responseText),c=["6","7"],a=0;a<c.length;++a){var f=google.maps.geometry.encoding.decodePath(d.data[c[a]].attributes.polyline);(new google.maps.Polyline({path:f,geodesic:!0,strokeOpacity:0,icons:[{icon:{path:"M 0,-1 0,1",
strokeOpacity:1,strokeColor:"green",strokeWeight:3,scale:4},offset:"0",repeat:"30px"}]})).setMap(e)}};b.send()})();k();(function(){var b=[new google.maps.LatLng(42.352514,-71.118344),new google.maps.LatLng(42.3536,-71.118092),new google.maps.LatLng(42.353687,-71.117968),new google.maps.LatLng(42.353683,-71.117775),new google.maps.LatLng(42.35319,-71.116724),new google.maps.LatLng(42.352641,-71.115673),new google.maps.LatLng(42.352482,-71.115479),new google.maps.LatLng(42.351745,-71.115656),new google.maps.LatLng(42.351007,
...
-71.11685),new google.maps.LatLng(42.35363,-71.11761),new google.maps.LatLng(42.35372,-71.11794),new google.maps.LatLng(42.35364,-71.11811),new google.maps.LatLng(42.3531,-71.11822),new google.maps.LatLng(42.35154,-71.11855),new google.maps.LatLng(42.35134,-71.1186),new google.maps.LatLng(42.35132,-71.11826)],c=new XMLHttpRequest;c.open("GET","api/buShuttle",!0);c.onreadystatechange=function(){if(4==c.readyState&&"200"==c.status){var a=JSON.parse(this.responseText);"fall"==a.service_id?(new google.maps.Polyline({path:b,
geodesic:!0,strokeColor:"#FF0000",strokeOpacity:1,strokeWeight:2})).setMap(e):("lnw1"==a.service_id||null==a.service_id)&&(new google.maps.Polyline({path:d,geodesic:!0,strokeColor:"#FF0000",strokeOpacity:1,strokeWeight:2})).setMap(e)}};c.send()})();l()};
